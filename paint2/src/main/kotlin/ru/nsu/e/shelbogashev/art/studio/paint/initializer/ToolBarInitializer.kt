...
class ToolBarInitializer {
    ...
    fun initToolBar(application: PaintApplication): JToolBar {
        ...
        val buttonConfigs = listOf(
            ButtonConfig("toolbar_button_undo", IconResource.UNDO, "toolbar_button_hint_undo"),
            ButtonConfig("toolbar_button_eraser", IconResource.ERASER, "toolbar_button_hint_eraser"),
            ButtonConfig("toolbar_button_pen", IconResource.PEN, "toolbar_button_hint_pen", selected = true),
            ...
            ButtonConfig(
                "toolbar_button_palette",
                IconResource.PALETTE,
                "toolbar_button_hint_palette"
            ),
        ...
        buttonConfigs.forEach { config ->
            ...
            val button = buildToolbarButton(config.id, icon, tooltip, config.background, config.selected)
            toolBar.add(button)
